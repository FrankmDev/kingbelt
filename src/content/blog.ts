...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    imageAlt: 'Artesano alisando una pieza de cuero en el banco de trabajo del taller',
  ...
  },
  {
    ...
    imageAlt: 'Tres cinturones de cuero marrón KingBelt con costura en contraste y hebilla plateada',
  ...
  },
  {
    ...
    imageAlt: 'Banco de talabartería con herramientas y recortes de cuero negro y marrón',
  ...
  },
  {
    ...
    readingTime: '4 min',
    image: '/images/imagen-cinturon-kingbelt-13.avif',
    imageAlt: 'Cinturones de cuero negro y marrón KingBelt sobre piedra natural',
  ...
  },
  {
    ...
    imageAlt: 'Detalle de hebilla plateada y costura en contraste sobre cinturón de cuero marrón',
  ...
  },
  {
    ...
    imageAlt: 'Cinturones de cuero marrón y negro KingBelt sobre tejido claro',
...
export const blogPage = {
  ...
  hero: {
    ...
    image: '/images/imagen-cinturon-kingbelt-12.avif',
    imageAlt: 'Colección de cinturones de cuero marrón y negro KingBelt enrollados',
  ...
  sections: {
    publications: {
      ...
      title: 'Últimas <em>publicaciones</em>.',
      body: 'Guías concretas y piezas de lectura sobre estilo, materiales, uso y cultura de carretera.',
      meta: 'Cuaderno 01 · Verano 2026',
    },
    selection: {
      index: '02',
      eyebrow: 'Selección editorial',
      title: 'Lecturas para <em>volver</em>.',
      body: 'Una lectura principal y dos referencias concretas sobre medida, herrajes y proporción.',
      meta: '3 lecturas de referencia',
    },
    reading: {
      index: '01',
      eyebrow: 'Desarrollo',
      title: 'El artículo <em>desarrollado</em>.',
    },
    related: {
      index: '02',
      eyebrow: 'Continúa leyendo',
      title: 'Otras piezas del <em>cuaderno</em>.',
      body: 'Más lecturas del cuaderno sobre estilo, materiales, proporción y uso real.',
      meta: 'Artículos relacionados',
      cta: { label: 'Ver toda la revista', href: '/blog' },
    },
    brandCta: {
      index: '03',
      eyebrow: 'Detrás de la revista',
      title: 'De la lectura a <em>la marca</em>.',
      body: 'El criterio editorial nace de una forma de mirar el producto: proporción, función, material y uso real.',
      label: 'Conocer KingBelt',
      href: '/sobre',
    },
  },
} as const;
